...
//		}
	...
	private static CtClass getCtMethodParam(Parameter parameter) {
		...
		// Annotation("javax.xml.bind.annotation.XmlAccessorType", cp);
		// annotation.addMemberValue("value", new
		// ClassMemberValue("javax.xml.bind.annotation.XmlAccessType.FIELD",
		// cp));
		// Iterator<java.util.Map.Entry<String, String>> iterator = params
		// .entrySet().iterator();
		// while (iterator.hasNext()) {
